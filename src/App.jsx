...
const MOTIVATIONS = [
  ...
  // Epictetus — verified Enchiridion / Discourses
  ...
  { q:"Seek not that the things which happen should happen as you wish; but wish the things which happen to be as they are.", a:"Epictetus" },
  // Seneca — verified Letters / Essays
  ...
  // Alan Watts — verified lectures / books
  ...
  // David Goggins — verified Can't Hurt Me
  { q:"You are stopping at 40% of what you actually have.", a:"David Goggins" },
